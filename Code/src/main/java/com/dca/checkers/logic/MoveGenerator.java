...
package com.dca.checkers.logic;
...
public class MoveGenerator {
	...
	public static boolean isValidSkip(Board board,
		...
		if (id == Board.INVALID || id == Board.EMPTY)
			return false;
		if (midID == Board.INVALID || midID == Board.EMPTY)
			return false;
		...
		if((id == Board.WHITE_CHECKER && midID == Board.BLACK_KING) || (id == Board.BLACK_CHECKER && midID == Board.WHITE_KING))
			return false;
